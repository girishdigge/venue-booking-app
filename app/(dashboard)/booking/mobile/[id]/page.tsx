        ...
        <div className='relative z-10 space-y-6 print:space-y-3'>
          ...
          <div className='bg-gradient-to-r from-amber-700 via-amber-800 to-amber-900 text-white p-2 rounded-xl shadow-lg'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center'>
                <div className='w-48 h-48 flex items-center justify-center bg-white/10 backdrop-blur-sm rounded-xl shadow-inner mr-4 border border-amber-600'>
                  <Image
                    src='/logo.jpg'
                    alt='logo'
                    height={200}
              ...
              <div className='hidden md:flex flex-col text-right text-sm text-amber-100 print:text-xs bg-amber-900/40 p-3 rounded-lg backdrop-blur-sm'>
